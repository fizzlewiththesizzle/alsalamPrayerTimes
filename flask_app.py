...
def home():
    ...
    if month == 1:
        filename = "/home/faisal/mysite/January.csv"
    elif month == 2:
        filename = "/home/faisal/mysite/February.csv"
    elif month == 3:
        filename = "/home/faisal/mysite/March.csv"
    elif month == 4:
        filename = "/home/faisal/mysite/April.csv"
    elif month == 5:
        filename = "/home/faisal/mysite/May.csv"
    elif month == 6:
        filename = "/home/faisal/mysite/June.csv"
    elif month == 7:
        filename = "/home/faisal/mysite/July.csv"
    elif month == 8:
        filename = "/home/faisal/mysite/August.csv"
    elif month == 9:
        filename = "/home/faisal/mysite/September.csv"
    elif month == 10:
        filename = "/home/faisal/mysite/October.csv"
    elif month == 11:
        filename = "/home/faisal/mysite/November.csv"
    elif month == 12:
        filename = "/home/faisal/mysite/December.csv"
    else: 
